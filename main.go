...
func main() {
	...
	resolvers.Register("invitation.team.noorg", collector.ConfiguredVars(config, collector.NewInvitationResolver(witClient)), nil)
	resolvers.Register("invitation.space.noorg", collector.ConfiguredVars(config, collector.NewInvitationResolver(witClient)), nil)
